...
const nodalisErrorLogFormat = Winston.format.printf((info) => {
...
const nodalisLogFormat = Winston.format.printf((info) => {
...
const logger = Winston.createLogger({
	...
	format: Winston.format.combine(
		Winston.format.label({ label: 'Nodalis::Logger::Error' }),
