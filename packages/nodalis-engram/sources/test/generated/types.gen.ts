/**
 * This file was generated by Nodalis Engram
...
export type EngramGenScalarNames =
	| 'Boolean'
	| 'Float'
	| 'ID'
	| 'Int'
...
export interface EngramGenTypes {
	...
	allInputTypes:
		| EngramGenTypes['inputNames']
		| EngramGenTypes['enumNames']
		| EngramGenTypes['scalarNames'];
	allOutputTypes:
		| EngramGenTypes['objectNames']
		| EngramGenTypes['enumNames']
		| EngramGenTypes['unionNames']
		| EngramGenTypes['interfaceNames']
		| EngramGenTypes['scalarNames'];
	allNamedTypes:
		| EngramGenTypes['allInputTypes']
		| EngramGenTypes['allOutputTypes'];
	abstractTypes:
		| EngramGenTypes['interfaceNames']
		| EngramGenTypes['unionNames'];
