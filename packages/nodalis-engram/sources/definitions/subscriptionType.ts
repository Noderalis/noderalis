...
export interface SubscriptionScalarConfig<
...
export interface SubscriptionDefinitionBuilder
	extends ObjectDefinitionBuilder<'Subscription'> {}
...
export type EngramSubscriptionTypeConfig = {
	name: 'Subscription';
	definition(t: SubscriptionDefinitionBlock): void;
};

export function subscriptionType(
	config: Omit<EngramSubscriptionTypeConfig, 'name'>
) {
