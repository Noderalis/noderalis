...
export interface GroupedTypes {
	...
	scalar: Array<GraphQLScalarType & { asEngramMethod?: string }>;
}
...
withEngramSymbol(PrintedGenTypingImport, EngramTypes.PrintedGenTypingImport);
...
withEngramSymbol(PrintedGenTyping, EngramTypes.PrintedGenTyping);
