...
import { EngramTypes, withEngramSymbol } from './definitions/_types';
...
withEngramSymbol(DynamicInputMethodDef, EngramTypes.DynamicInput);
...
withEngramSymbol(DynamicOutputMethodDef, EngramTypes.DynamicOutputMethod);
