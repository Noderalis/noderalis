...
import { EngramObjectTypeDef, objectType } from '../definitions/objectType';
import { dynamicOutputMethod } from '../dynamicMethod';

const relayConnectionMap = new Map<string, EngramObjectTypeDef<string>>();

let pageInfo: EngramObjectTypeDef<string>;
