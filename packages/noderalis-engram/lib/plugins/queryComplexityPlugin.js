...
const QueryComplexityImport = utils_1.printedGenTypingImport({
    module: '@engram/schema/dist/plugins/queryComplexityPlugin',
...
exports.queryComplexityPlugin = () => {
    ...
    `,
        ...
        onCreateFieldResolver(config) {
            var _a, _b, _c, _d;
            // Look for complexity property defined in the engram config
            const complexity = (_b = (_a = config.fieldConfig.extensions) === null || _a === void 0 ? void 0 : _a.engram) === null || _b === void 0 ? void 0 : _b.config.complexity;
            ...
            if (typeof complexity !== 'number' && typeof complexity !== 'function') {
                ...
                const fieldName = (_d = (_c = config.fieldConfig.extensions) === null || _c === void 0 ? void 0 : _c.engram) === null || _d === void 0 ? void 0 : _d.config.name;
