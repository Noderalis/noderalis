...
exports.createPlugin = exports.plugin = exports.EngramPlugin = exports.composeMiddlewareFns = exports.completeValue = void 0;
...
function completeValue(valOrPromise, onSuccess, onError) {
    if (utils_1.isPromiseLike(valOrPromise)) {
...
exports.EngramPlugin = EngramPlugin;
_types_1.withEngramSymbol(EngramPlugin, _types_1.EngramTypes.Plugin);
/**
