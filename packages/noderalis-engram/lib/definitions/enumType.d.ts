...
export declare class EngramEnumTypeDef<TypeName extends string> {
...
export declare function enumType<TypeName extends string>(config: EnumTypeConfig<TypeName>): EngramEnumTypeDef<TypeName>;
export {};
